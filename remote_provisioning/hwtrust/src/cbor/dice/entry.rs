...
impl Payload {
    ...
    fn from_entries(
        ...
        let possibly_degenerate = false;
        let f = PayloadFields::from_entries(
            profile,
            entries,
            config_format,
            is_root,
...
impl PayloadFields {
    ...
    fn from_entries(
        ...
        Ok(Self {
            ...
            mode: validate_mode(profile, mode, is_root, possibly_degenerate, allow_any_mode)?,
...
fn validate_mode(
    ...
    .map(|mode| {
        ...
        if !possibly_degenerate && mode != DiceMode::Normal && !allow_any_mode {
